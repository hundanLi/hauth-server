package com.hauth.auth.cas3;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.dataformat.xml.XmlMapper;
import com.hauth.auth.cas3.constant.ErrorCodeConstant;
import com.hauth.auth.cas3.dto.ServiceValidateDTO;
...
public class CasAuthController {
    ...
    public String login(HttpServletResponse response,
        ...
        if (hasLogin(request)) {
            String user = (String) request.getSession(false).getAttribute(principal);
